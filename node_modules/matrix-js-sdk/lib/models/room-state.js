...
export class RoomState extends TypedEventEmitter {
  ...
  constructor(roomId) {
    ...
    var isStartTimelineState = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    super();
    this.roomId = roomId;
  ...
  setStateEvents(stateEvents, options) {
    ...
    stateEvents.forEach(event => {
      var _lastStateEvent$event, _event$event$unsigned;
      ...
      var lastReplaceId = lastStateEvent === null || lastStateEvent === void 0 || (_lastStateEvent$event = lastStateEvent.event.unsigned) === null || _lastStateEvent$event === void 0 ? void 0 : _lastStateEvent$event.replaces_state;
      var lastId = lastStateEvent === null || lastStateEvent === void 0 ? void 0 : lastStateEvent.event.event_id;
      var newReplaceId = (_event$event$unsigned = event.event.unsigned) === null || _event$event$unsigned === void 0 ? void 0 : _event$event$unsigned.replaces_state;
      var newId = event.event.event_id;
