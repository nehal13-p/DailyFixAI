...
import { EventType, MsgType, RelationType, UNSIGNED_THREAD_ID_FIELD } from "../@types/event.ts";
import { Crypto } from "../crypto/index.ts";
import { RoomMember } from "./room-member.ts";
import { Thread, ThreadEvent, ThreadEventHandlerMap } from "./thread.ts";
...
export declare class MatrixEvent extends TypedEventEmitter<MatrixEventEmittedEvents, MatrixEventHandlerMap> {
     ...
     *   not report it.
     */
    getMembershipAtEvent(): Optional<Membership | string>;
    /**
