...
import { Beacon, BeaconEvent, BeaconEventHandlerMap, BeaconIdentifier } from "./beacon.ts";
...
export declare class RoomState extends TypedEventEmitter<EmittedEvents, EventHandlerMap> {
    ...
    readonly isStartTimelineState: boolean;
     ...
     */
    setStateEvents(stateEvents: MatrixEvent[], options?: IMarkerFoundOptions): void;
