...
export class Relations extends TypedEventEmitter {
  ...
  getLastReplacement() {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (lastReplacement !== null && lastReplacement !== void 0 && lastReplacement.shouldAttemptDecryption() && _this4.client.isCryptoEnabled()) {
        yield lastReplacement.attemptDecryption(_this4.client.crypto);
