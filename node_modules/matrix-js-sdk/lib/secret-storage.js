...
export class ServerSideSecretStorageImpl {
  ...
  getKey(keyId) {
    ...
    return _asyncToGenerator(function* () {
      ...
      var keyInfo = yield _this3.accountDataAdapter.getAccountDataFromServer("m.secret_storage.key." + keyId);
  ...
  store(name, secret, keys) {
    ...
    return _asyncToGenerator(function* () {
      ...
      for (var _keyId of keys) {
        ...
        var _keyInfo = yield _this5.accountDataAdapter.getAccountDataFromServer("m.secret_storage.key." + _keyId);
        if (!_keyInfo) {
  ...
  get(name) {
    ...
    return _asyncToGenerator(function* () {
      ...
      for (var _keyId2 of Object.keys(secretInfo.encrypted)) {
        // get key information from key storage
        var _keyInfo2 = yield _this6.accountDataAdapter.getAccountDataFromServer("m.secret_storage.key." + _keyId2);
  ...
  isStored(name) {
    ...
    return _asyncToGenerator(function* () {
      ...
      for (var _keyId3 of Object.keys(secretInfo.encrypted)) {
        // get key information from key storage
        var _keyInfo3 = yield _this7.accountDataAdapter.getAccountDataFromServer("m.secret_storage.key." + _keyId3);
