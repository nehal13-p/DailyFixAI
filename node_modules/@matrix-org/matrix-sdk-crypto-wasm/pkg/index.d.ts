...
*/
  keysForUpload(initial_device_display_name: string, pickle_key: Uint8Array): Promise<PutDehydratedDeviceRequest>;
}
/**
...
*/
  rehydrate(pickle_key: Uint8Array, device_id: DeviceId, device_data: string): Promise<RehydratedDevice>;
}
/**
...
* @returns {Array<any>}
*/
  requestVerification(methods?: any[]): Array<any>;
/**
...
* @returns {Promise<any>}
*/
  importBackedUpRoomKeys(backed_up_room_keys: Map<any, any>, progress_listener: Function | undefined, backup_version: string): Promise<any>;
/**
...
*/
  constructor(public_key: Curve25519PublicKey, rendezvous_url: string, server_name?: string);
/**
...
*/
  static open(store_name?: string, store_passphrase?: string): Promise<StoreHandle>;
/**
...
*/
  requestVerification(room_id: RoomId, request_event_id: EventId, methods?: any[]): VerificationRequest;
/**
...
* @returns {string}
*/
  static request(own_user_id: UserId, own_device_id: DeviceId, other_user_id: UserId, methods?: any[]): string;
/**
